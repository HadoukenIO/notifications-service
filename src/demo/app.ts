...
const buttonNote: NotificationOptions = {
    ...
    customData: {testContext: 'testContext'},
    date: new Date(),
    buttons: [{title: 'test1', iconUrl: 'favicon.ico'}, {title: 'test1', iconUrl: 'favicon.ico'}, {title: 'test1', iconUrl: 'favicon.ico'}, {title: 'test1', iconUrl: 'favicon.ico'}, {title: 'test1', iconUrl: 'favicon.ico'}, {title: 'test1', iconUrl: 'favicon.ico'}, {title: 'test2', iconUrl: 'favicon.ico'}, {title: 'test2', iconUrl: 'favicon.ico'}]
};
