...
// For testing/display purposes
const notificationButtonClicked = (payload: Notification & ISenderInfo, sender: ISenderInfo) => {
...
async function createClientPromise() {
    ...
    client.register('notification-button-clicked', (payload: Notification & ISenderInfo, sender: ISenderInfo) => { callbacks.notificationButtonClicked(payload, sender); });
