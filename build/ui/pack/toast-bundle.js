...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/provider/ui/toast/index.tsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./C:/Users/ryan/AppData/Roaming/npm/node_modules/webpack/buildin/global.js":
/*!***********************************!*\
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! (webpack)/buildin/global.js */ "./C:/Users/ryan/AppData/Roaming/npm/node_modules/webpack/buildin/global.js")))
...
/***/ "./src/provider/ui/toast/components/Toast/Toast.tsx":
/*!**********************************************************!*\
  !*** ./src/provider/ui/toast/components/Toast/Toast.tsx ***!
  \**********************************************************/
/*! no static exports found */
...
function Toast(props) {
    ...
    return (React.createElement("div", { className: "notification-container" },
        React.createElement("div", { className: "notification-inbox", id: "notification-inbox" },
            React.createElement("ul", { id: "notification-inbox-list" },
                React.createElement("li", { className: "notification-item" },
                    React.createElement("img", { className: "notification-close-x", src: "image/shapes/notifications-x.png", alt: "", onClick: () => {
                            clickHandler(1 /* Closed */);
                        } }),
                    React.createElement("div", { className: "notification-body", onClick: () => {
                            clickHandler(0 /* BodyClick */);
                        } },
                        React.createElement("div", { className: "notification-source" },
                            React.createElement("img", { src: props.meta.icon, className: "notification-small-img" }),
                            React.createElement("span", { className: "notification-source-text" }, props.meta.name)),
                        React.createElement("div", { className: "notification-body-title" }, props.meta.title),
                        React.createElement("div", { className: "notification-body-text" }, props.meta.body)))))));
}
exports.Toast = Toast;
...
/***/ "./src/provider/ui/toast/container/App.tsx":
/*!*************************************************!*\
  !*** ./src/provider/ui/toast/container/App.tsx ***!
  \*************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
const Toast_1 = __webpack_require__(/*! ../components/Toast/Toast */ "./src/provider/ui/toast/components/Toast/Toast.tsx");
class App extends React.Component {
    constructor(props) {
        super(props);
        this.state = { meta: null };
        window.onNotificationMessage = this.onNotificationMessage.bind(this);
        fin.desktop.Window.getCurrent().animate({ opacity: { opacity: 1, duration: 200 } }, { interrupt: false });
    }
    render() {
        if (this.state.meta) {
            return React.createElement(Toast_1.Toast, { meta: this.state.meta });
        }
        return null;
    }
...
/***/ "./src/provider/ui/toast/index.tsx":
/*!*****************************************!*\
  !*** ./src/provider/ui/toast/index.tsx ***!
  \*****************************************/
/*! no static exports found */
...
const React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
const App_1 = __webpack_require__(/*! ./container/App */ "./src/provider/ui/toast/container/App.tsx");
const config_1 = __webpack_require__(/*! ../../../shared/config */ "./src/shared/config.ts");
fin.desktop.main(async () => {
    const opts = { payload: { version: 'center' } };
    const pluginP = fin.InterApplicationBus.Channel.connect(config_1.CHANNEL_NAME, opts);
    function notificationCreated(payload, sender) {
    ...
    function notificationCleared(payload, sender) {
        // For testing/display purposes
    ...
    function appNotificationsCleared(payload, sender) {
        // For testing/display purposes
    ...
    window.openfin = {
        notifications: {
            ...
            buttonClickHandler: async (payload, buttonIndex) => {
                // Handle a click on a notification
                const plugin = await pluginP;
            ...
            fetchAppNotifications: async (uuid) => {
            ...
            addEventListener: async (event, cb) => {
    ...
    const plugin = await pluginP;
    plugin.register('notification-created', (payload, sender) => callbacks.notificationCreated(payload, sender));
    plugin.register('notification-cleared', (payload, sender) => callbacks.notificationCleared(payload, sender));
    plugin.register('app-notifications-cleared', (payload, sender) => callbacks.appNotificationsCleared(payload, sender));
});
react_dom_1.render(React.createElement(App_1.App, null), document.getElementById('toast-app'));
